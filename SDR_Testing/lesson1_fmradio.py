...
# Title: Lesson1 Fmradio
# Generated: Wed Jan 31 15:30:40 2018
##################################################
...
class lesson1_fmradio(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "Lesson1 Fmradio")
        Qt.QWidget.__init__(self)
        self.setWindowTitle("Lesson1 Fmradio")
        ...
        self.settings = Qt.QSettings("GNU Radio", "lesson1_fmradio")
        ...
        # Blocks
        ##################################################
        self._audio_gain_range = Range(0, 100, 1, 50, 200)
...
def main(top_block_cls=lesson1_fmradio, options=None):
