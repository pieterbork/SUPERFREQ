...
def main(top_block_cls=wifi_rx_rftap, options=None):
    doteleven_freqs = [2.412, 2.417, 2.422, 2.427, 2.432, 2.437, 2.442, 2.447, 2.452, 2.457, 2.462, 5035, 5.040, 5.045, 5.055, 5.060, 5.080, 5.170, 5.180, 5.190, 5.200, 5.210, 5.220, 5.230, 5.240, 5.250, 5.260, 5.270, 5.280, 5.290, 5.300, 5.310, 5.320, 5.500, 5.510, 5.520, 5.530, 5.540, 5.550, 5.560, 5.570, 5.580, 5.590, 5.600, 5.610, 5.620, 5.630, 5.640, 5.660, 5.670, 5.680, 5.690, 5.700, 5.710, 5.720, 5.745, 5.755, 5.765, 5.775, 5.785, 5.795, 5.805, 5.825]
    tb = top_block_cls()
    tb.Start(True)
