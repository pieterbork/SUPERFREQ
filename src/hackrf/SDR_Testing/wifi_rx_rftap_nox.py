...
parser = argparse.ArgumentParser(description="Run SUPERFREQ wifi scan")
parser.add_argument("--ch", default="", help="A comma separated list of wifi channel numbers, default is all channels, channels 7,8,9,&11 must be differentiated between 2.4 and 5 GHz (e.g. 7_24 for 2.4 GHz channel 7 and 7_5 for 5 GHz channel 7), unknown channels will be ignored")
